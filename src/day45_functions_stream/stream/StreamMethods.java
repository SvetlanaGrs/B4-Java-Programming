...
public class StreamMethods {
    public static void main(String[] args) {
        ...
        //.stream(); ---> array & arrayList

        //#1 - stream with array
        //To use stream with array -we need to convert array into stream
        int [] arr = {1, 2, 3, 4, 5};
        //arr.stream(); //Not valid with array
        Arrays.stream(arr); // How we can convert array into stream
        ...
        // str.split(""); // converts string into string []
