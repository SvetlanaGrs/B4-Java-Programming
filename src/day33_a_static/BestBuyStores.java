...
public class BestBuyStores {
    public static void main(String[] args) {
        ...
        // it is a good way to call! Proper way is to use class name to call static members
        ...
        System.out.println();
        BestBuy.headquarter = "900 Test street South, Richfield, Alaska";
        System.out.println(store1.headquarter);
        System.out.println(store2.headquarter);
        System.out.println(store3.headquarter);
        ...
        System.out.println("-----------------------------------------------");
        //BestBuy.openStore(); not works
        //Can not be reach by class name
        store1.openStore();
        store2.openStore();
        store3.openStore();

        System.out.println("------------------------------------------------");
        BestBuy.specialDaySale(); // good approach
