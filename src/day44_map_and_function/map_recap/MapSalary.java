...
public class MapSalary {
    public static void main(String[] args) {
       ...
       employeesSalaryInfo.put("James.B", 6500.0);
        ...
        //2 we can convert all the values into COllection Data structure - treeSet and get the first and last
